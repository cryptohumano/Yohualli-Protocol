# Protocol documentation languages

**English** and **Español (América Latina, neutral)** are maintained together for the **entry points and operational** protocol docs:
...
| [Yohualli Protocol draft 1.1.md](Yohualli%20Protocol%20draft%201.1.md) | **Primarily Spanish**; English release as a follow-up to freeze formulas |

**Style:** in Spanish, use **tú** for user-facing steps; **avoid** Rioplatense *voseo* in those steps (*usa* / *copia*, not *usá* / *copiá*).  
